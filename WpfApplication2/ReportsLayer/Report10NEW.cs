...
namespace WpfApplication2.ReportsLayer {
    ...
    public class Report10NEW : ReportClass {
        ...
        public override string FullResourceName {
            get {
                return "WpfApplication2.ReportsLayer.Report10NEW.rpt";
            }
            set {
                // Do nothing
            }
    ...
    public class CachedReport10NEW : Component, ICachedReport {
        
        public CachedReport10NEW() {
        }
        ...
        public virtual CrystalDecisions.CrystalReports.Engine.ReportDocument CreateReport() {
            Report10NEW rpt = new Report10NEW();
            rpt.Site = this.Site;
            return rpt;
        }
