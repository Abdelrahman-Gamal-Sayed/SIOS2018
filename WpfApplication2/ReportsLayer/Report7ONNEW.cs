...
namespace WpfApplication2.ReportsLayer {
    ...
    public class Report7ONNEW : ReportClass {
        ...
        public override string FullResourceName {
            get {
                return "WpfApplication2.ReportsLayer.Report7ONNEW.rpt";
            }
            set {
                // Do nothing
            }
    ...
    public class CachedReport7ONNEW : Component, ICachedReport {
        
        public CachedReport7ONNEW() {
        }
        ...
        public virtual CrystalDecisions.CrystalReports.Engine.ReportDocument CreateReport() {
            Report7ONNEW rpt = new Report7ONNEW();
            rpt.Site = this.Site;
            return rpt;
        }
